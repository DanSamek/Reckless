...
use crate::{
    board::Board,
    history::{ContinuationCorrectionHistory, ContinuationHistory, CorrectionHistory, NoisyHistory, QuietHistory, CutNodeCorrectionHistory},
    nnue::Network,
...
pub struct ThreadData {
    ...
    pub cutnode_correction_history: CutNodeCorrectionHistory,
...
impl ThreadData {
    pub fn new(shared: Arc<SharedContext>) -> Self {
        Self {
            ...
            cutnode_correction_history: CutNodeCorrectionHistory::default(),
            best_move_changes: 0,
            optimism: [0; 2],
            stopped: false,
            root_depth: 0,
